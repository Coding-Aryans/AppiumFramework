...
import com.CommonUtils.ExtentManager;
...
//				utils.PLATFORM_VERSION);
		capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME,
				utils.PLATFORM_NAME);
		capabilities.setCapability(MobileCapabilityType.DEVICE_NAME,
				utils.DEVICE_NAME);
		capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME,
				utils.AUTOMATION_INSTRUMENTATION);
//		capabilities.setCapability(MobileCapabilityType.APP, utils.APPLICATION_NAME);
		capabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT,
				utils.NEW_COMMAND_TIMEOUT);
		capabilities.setCapability(AndroidMobileCapabilityType.DEVICE_READY_TIMEOUT,
				utils.DEVICE_READY_TIMEOUT);
		capabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, utils.APP_ACTIVITY);
		capabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE,utils.BASE_PKG);
	}
